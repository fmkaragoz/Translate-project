...
const App = () => {
  ...
  return (
    <div className="bg-slate-700 h-screen text-white grid place-items-center">
      <div className="w-[80vw] max-w-[1100px] flex flex-col justify-center">
        ...
        <div className="flex gap-2 text-black">
          ...
          <button
            ...
            className="rounded py-2 px-6 bg-slate-800 text-white transition hover:ring-2 hover:bg-slate-900 "
          >
            Değiş
          </button>
        ...
        <button
          ...
          className="rounded-md py-3 px-5 text-[17px] font-semibold cursor-pointer bg-slate-800 mt-3 hover:ring-2 hover:bg-slate-900 transition"
        >
          Çevir
        </button>
      </div>
